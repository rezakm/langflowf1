...
if [ -z "$DEEPTERN_API_KEY" ]; then
  echo "Error: DEEPTERN_API_KEY environment variable not found. Please set your API key in the environment variables."
fi
`
      : ""
  }curl --request POST \\
  ...
  --header 'Content-Type: application/json' \\${
    isAuthenticated
      ? `
  --header "x-api-key: $DEEPTERN_API_KEY" \\`
      : ""
  }
