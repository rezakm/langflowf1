...
if (!process.env.DEEPTERN_API_KEY) {
    throw new Error('DEEPTERN_API_KEY environment variable not found. Please set your API key in the environment variables.');
}
`
      : ""
  }const payload = {
